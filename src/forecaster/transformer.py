...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, num_layers, num_heads,
        ...
        self.encoder_layers = nn.TransformerEncoderLayer(hidden_dim, num_heads, dropout=0.3, dim_feedforward=128)
...
class TransformerDecoder(nn.Module):
    def __init__(self, input_dim, num_heads, hidden_dim, num_layers, output_dim):
        ...
        dec_layer = nn.TransformerDecoderLayer(input_dim, num_heads, hidden_dim, dropout=0.3)
...
class TransformerEncoderDecoder(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, hidden_dim, seq_length, num_layers, num_heads, num_regions, rnn_hidden_dim, rnn_layers, decoder_name='rnn'):
